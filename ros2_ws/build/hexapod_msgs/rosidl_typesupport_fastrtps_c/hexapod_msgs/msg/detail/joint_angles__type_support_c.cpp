...
#include "hexapod_msgs/msg/detail/joint_angles__rosidl_typesupport_fastrtps_c.h"
...
using _JointAngles__ros_msg_type = hexapod_msgs__msg__JointAngles;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hexapod_msgs__msg__JointAngles;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const hexapod_msgs__msg__JointAngles * ros_message = static_cast<const hexapod_msgs__msg__JointAngles *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_hexapod_msgs__msg__JointAngles(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  hexapod_msgs__msg__JointAngles * ros_message = static_cast<hexapod_msgs__msg__JointAngles *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_hexapod_msgs__msg__JointAngles(cdr, ros_message);
}

static uint32_t _JointAngles__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hexapod_msgs__msg__JointAngles(
...
static size_t _JointAngles__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hexapod_msgs__msg__JointAngles(
