...
#include "hexapod_msgs/msg/detail/polygon__rosidl_typesupport_fastrtps_c.h"
...
using _Polygon__ros_msg_type = hexapod_msgs__msg__Polygon;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hexapod_msgs__msg__Polygon;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const hexapod_msgs__msg__Polygon * ros_message = static_cast<const hexapod_msgs__msg__Polygon *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_hexapod_msgs__msg__Polygon(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  hexapod_msgs__msg__Polygon * ros_message = static_cast<hexapod_msgs__msg__Polygon *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_hexapod_msgs__msg__Polygon(cdr, ros_message);
}

static uint32_t _Polygon__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hexapod_msgs__msg__Polygon(
...
static size_t _Polygon__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hexapod_msgs__msg__Polygon(
