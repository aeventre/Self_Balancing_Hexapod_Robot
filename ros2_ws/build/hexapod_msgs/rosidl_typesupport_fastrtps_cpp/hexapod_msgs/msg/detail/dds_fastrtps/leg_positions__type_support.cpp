...
#include "hexapod_msgs/msg/detail/leg_positions__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const hexapod_msgs::msg::LegPositions & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hexapod_msgs::msg::LegPositions & ros_message)
{
  // Member: positions
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hexapod_msgs::msg::LegPositions;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hexapod_msgs::msg::LegPositions *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hexapod_msgs::msg::LegPositions *>(
    untyped_ros_message);
...
{
  return &hexapod_msgs::msg::typesupport_fastrtps_cpp::_LegPositions__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hexapod_msgs, msg, LegPositions)() {
  return &hexapod_msgs::msg::typesupport_fastrtps_cpp::_LegPositions__handle;
}
