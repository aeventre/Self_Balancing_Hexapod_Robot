...
#include "hexapod_msgs/msg/detail/joint_angles__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hexapod_msgs::msg::JointAngles;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hexapod_msgs::msg::JointAngles *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hexapod_msgs::msg::JointAngles *>(
    untyped_ros_message);
...
{
  return &hexapod_msgs::msg::typesupport_fastrtps_cpp::_JointAngles__handle;
}
