...
bool hexapod_msgs__msg__leg_commands__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hexapod_msgs.msg._leg_commands.LegCommands", full_classname_dest, 42) == 0);
  }
  hexapod_msgs__msg__LegCommands * ros_message = _ros_message;
  {  // positions
...
{
  /* NOTE(esteve): Call constructor of LegCommands */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("hexapod_msgs.msg._leg_commands");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LegCommands");
