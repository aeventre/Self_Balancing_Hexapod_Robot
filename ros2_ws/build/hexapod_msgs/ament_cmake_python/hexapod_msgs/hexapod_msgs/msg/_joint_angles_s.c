...
bool hexapod_msgs__msg__joint_angles__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hexapod_msgs.msg._joint_angles.JointAngles", full_classname_dest, 42) == 0);
  }
  hexapod_msgs__msg__JointAngles * ros_message = _ros_message;
  {  // angles
...
PyObject * hexapod_msgs__msg__joint_angles__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("hexapod_msgs.msg._joint_angles");
