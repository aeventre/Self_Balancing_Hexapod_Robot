...
bool hexapod_msgs__msg__leg_positions__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("hexapod_msgs.msg._leg_positions.LegPositions", full_classname_dest, 44) == 0);
  }
  hexapod_msgs__msg__LegPositions * ros_message = _ros_message;
  {  // positions
...
PyObject * hexapod_msgs__msg__leg_positions__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("hexapod_msgs.msg._leg_positions");
