...
from hexapod_msgs.msg import LegPositions  # Custom message for foot positions
from std_msgs.msg import Bool, BoolMultiArray  # Contact states
...
class CoMCalculatorNode(Node):
    ...
    def foot_status_callback(self, msg):
        """Update foot contact states from BoolMultiArray message."""
    ...
    def calculate_com(self):
        ...
        self.get_logger().info(f'Calculated CoM: x={approx_com[0]}, y={approx_com[1]}, z={approx_com[2]}')
