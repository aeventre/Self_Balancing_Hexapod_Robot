...
#ifndef HEXAPOD_MSGS__MSG__DETAIL__LEG_COMMANDS__TYPE_SUPPORT_H_
#define HEXAPOD_MSGS__MSG__DETAIL__LEG_COMMANDS__TYPE_SUPPORT_H_
...
#endif  // HEXAPOD_MSGS__MSG__DETAIL__LEG_COMMANDS__TYPE_SUPPORT_H_
